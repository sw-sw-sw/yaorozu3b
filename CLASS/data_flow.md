...
graph TB
    ...
    subgraph TensorFlowSimulation
        ...
        TF_UP_P[update_property]
        TF_CF[calculate_forces]
    ...
    subgraph Box2DSimulation
        ...
        B2D_HAA[_handle_agent_added]
        B2D_HAR[_handle_agent_removed]
        B2D_STF[send_data_to_tf]
        B2D_STE[send_data_to_eco]
        B2D_UF[update_forces]
        B2D_UP_P[update_positions]
    ...
    subgraph VisualSystem
        ...
        VS_PQ[process_queue\nadd/remove]
        VS_HAA[_handle_agent_added]
        VS_HAR[_handle_agent_removed]
        VS_UB[update_buffer\nmain-loop]
