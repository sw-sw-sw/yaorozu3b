...
graph TB
    ...
    subgraph Box2DSimulation
        ...
        B2D_STE[send_data_to_eco_visual<br><br>positions<br>agent_ids<br>current_agent_count]
    ...
    subgraph VisualSystem
        ...
        VS_UP[update_property<br>main-loop<br><br>positions<br>agent_ids<br>current_agent_count]
    ...
    B2D_STE -->|positions, agent_ids, current_agent_count| VS_UP
    ```