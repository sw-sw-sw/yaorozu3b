...
class NumbaSimulation:
    ...
    @staticmethod
    def calculate_forces(positions, species, predator_species, prey_species, escape_distance, chase_distance, escape_weight, chase_weight):
        return calculate_forces_numba(positions, species, predator_species, prey_species, escape_distance, chase_distance, escape_weight, chase_weight)